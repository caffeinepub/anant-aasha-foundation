...
import { Menu, X, GraduationCap, BookOpen, Gamepad2, FileText } from 'lucide-react';
          ...
          <Sheet open={isMenuOpen} onOpenChange={setIsMenuOpen}>
            ...
            <SheetContent side="right" className="w-80 bg-white">
              <nav className="flex flex-col gap-1 mt-8">
                ...
                <Button
                  variant={currentPage === 'legal-info' ? 'secondary' : 'ghost'}
                  onClick={() => handleNavigate('legal-info')}
                  className="justify-start text-base py-6 rounded-xl pl-8"
                >
